    ...
    <h6 class="h6"> <?= $_SESSION['email']?> </h6>
      <nav class="main-nav">
        ...
        <ul class="navlinks" id="nl">
          <li class="ali" ><a id = "x1" > <label for="check" class="back" onclick="f('#')">Disponible</label></a></li>
          <li class="ali" ><a id = "x2"> <label for="check" onclick="f('#w1')">Evaluée</label></a></li>
          <li class="ali" ><a id = "x3" > <label for="check" onclick="f('#w2')">En Retard</label></a></li>
