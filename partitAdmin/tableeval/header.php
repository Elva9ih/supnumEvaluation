...
<!-- <h1 class="responsive-font-example">I am responsive</h1> -->
        <ul class="navlinks" id="nl">
          ...
          <!-- <select name="" id="ev"onchange="loc();" style="padding-bottom: 7px;border-bottom: 2px solid #7ebcb9;"> -->

          <select style="border:none;outline:none;width:108px;background:none" name="" id="ev"onchange="loc();">

          <option value="" selected disabled><a href=""><label>Evalution</label></a></option>
          <option value="../evaluation/index.php"><a href=""><label>Evalutions </label></a></option>
          <option value=""><a href=""><label>Evalution Details</label></a></option>

          <option value="../matiere/score_mat.php"><a href=""><label style="color: #00f;">Scores matieres </label></a></option>
