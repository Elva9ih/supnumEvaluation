...
if (isset($_POST["axe"])) {
    if ($_POST["axe"] != "Axe") {
     $sql_score = "SELECT score FROM reponse WHERE id_question in (SELECT id from question where id_axe=".$_POST["axe"].") ".$_SESSION["c_group"]." and id_evalu=$id_eval[0];";
...
if (isset($_POST["question"])) {
    ...
    $sql_score = "SELECT score FROM reponse WHERE id_evalu =$id_eval[0] ".$_SESSION["c_group"]." and id_question =".$_POST["question"];
...
const dataSource = [{
 ...
 <body>
  ...
  <div class="container my-20 pb-70 mt-n10" ><br><form action="" method="post">
