...
<option value="matiere/annees.php"><a href=""><label>Scores annees </label></a></option>
          ...
          <li class="ali" ><a href="#" id="dee"  onclick="myf1()"><img class="img1"  src="https://tinypic.host/images/2022/12/19/img_avatar.png" width="45" height="45"></a></li>
      ...
      <div class="div1" id="back1" style="display :none">
