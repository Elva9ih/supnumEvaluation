...
<!-- <h1 class="responsive-font-example">I am responsive</h1> -->
        <ul class="navlinks" id="nl">
          ...
          <li class="ali" ><a id = "" > <label for="check" onclick="f('')">Matiéres</label></a></li>

  
          <select style="border:none;outline:none;width:108px;" name="" id="ev"onchange="loc();">
          <option value="" selected disabled>Evaluation</option>
         
          <option value=""><a href=""><label>Evalutions </label></a></option>
          <option value="../tableeval/"><a href=""><label>Evalution Details </label></a></option>
          <option  value="" ><a href=""><label>Scores matieres </label></a></option>
          <option value="annees.php"><a href=""><label>Scores annees </label></a></option>
