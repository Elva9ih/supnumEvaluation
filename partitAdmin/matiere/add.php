                    ...
                    <div class="row">
                       ...
                       <input type="text" class="form-control col-md-11" placeholder="New module" name="module" id="add" style="display:none;">
                         <select class="form-select col-md-11" name="module" id="module">
                          ...
                          <img src="new.png" alt="" onclick="myf1()" id="back1" style="display:none;margin-left:95%;margin-top:-13.5%;width: 17px;height: 17px;"><img src="edit.jpeg" id="addn" alt="" onclick="myf()" style="margin-left:95%;margin-top:-13.5%;width: 17px;height: 17px;">
                       </div>
