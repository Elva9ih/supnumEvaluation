                ...
                <div class="row">
                    ...
                    <div class="mb-3 col-md-12">
                       ...
                       <input type="text" value="<?php echo $student['nommatieres']; ?>" name="nommatieres" class="form-control" required="">
                        ...
                        <div class="mb-3 col-md-12">
                        <input type="text" value="<?php echo $student['module']; ?>" class="form-control col-md-11" placeholder="New module" name="module" id="add1" style="display:none;">
                            <select class="form-select col-md-11" name="module" id="module">
                                <option selected disabled>Module</option>
                            </select><img src="new.png" alt="" onclick="myf1()" id="back1" style="display:none;margin-left:95%;margin-top:-13.5%;width: 17px;height: 17px;"><img src="edit.jpeg" id="addn1" alt="" onclick="myf()" style="margin-left:95%;margin-top:-13.5%;width: 17px;height: 17px;" >
                       </div>
...
<script>
    function myf(){
        ...
        document.getElementById("addn1").style.display = "none";
    }
    function myf1(){
        document.getElementById("module").style.display = "block";
        document.getElementById("back1").style.display = "none";
        document.getElementById("add1").style.display = "none";
        document.getElementById("addn1").style.display = "inline";
    }
