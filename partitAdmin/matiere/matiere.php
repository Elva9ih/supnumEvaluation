                    ...
                    <div class="container" style="width:100%">
                        <div class="card card-centered mb-3 mt-10" style="width:100%">
                            ...
                            <div class="card-header d-flex justify-content-between" style="width:100%">
                                <form style="djustify-content:space=between;" class="" action="" method="post"
                                    enctype="multipart/form-data">
                                    <input type="file" name="excel" required value="" class="exl"
                                        style="background-color:#4b64ff; color:white;border-radius :5%;">
                                    <button class="exl1"
                                        style="background-color:#4b64ff; color:white;border-radius :5%;" type="submit"
                                        name="import">Importer</button>
                                    <a href="add.php" class="btn btn-blue pluss"
                                        style="background-color:#4b64ff;color:#fff"><i class="fa-solid fa-plus"></i></a>
                                ...
                                <a href="add.php" class="btn btn-blue pluss1"
                                    style="background-color:#4b64ff;color:#fff"><i class="fa-solid fa-plus"></i></a>
                            </div>
                        </div>
                            ...
                            <table class="table table-bordered" id="myTable" style="width:100%">
                                <thead class="header round py-5 my-5">
                                    <tr style="background-color:rgb(27, 24, 24);">
                                        ...
                                        <th style="color: white; width: 20%; background-color:#4b64ff;">Departements
                                        </th>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <a href="edit.php?codematieres=<?php echo $array[0];?>"
                                                class="btn btn-secondar" id="btn1" class="edit" style="color:#00f"><i
                                                    class="fa-solid fa-pen"></i></a>


                                            <a href="delete.php?codematieres=<?php echo $array[0]; ?>"
                                                class="btn btn-dange" id="btn"><i class="fa-solid fa-trash"
